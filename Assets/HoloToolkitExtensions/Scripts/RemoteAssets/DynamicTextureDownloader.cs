    ...
    public class DynamicTextureDownloader : MonoBehaviour
    {
        ...
        private void CheckLoadImage()
        {
            ...
            if (_imageLoader != null &&_imageLoader.isDone && _geoimageLoader.isDone && !_appliedToTexture)
            {
                ...
                Destroy(GetComponent<Renderer>().material.GetTexture("_BaseTexture"));
                Destroy(GetComponent<Renderer>().material.GetTexture("_OverlayTexture"));
                ...
                Destroy(_geoimageLoader.texture);
                _imageLoader = null;
