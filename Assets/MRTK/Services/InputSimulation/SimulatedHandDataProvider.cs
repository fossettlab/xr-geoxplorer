...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class SimulatedHandDataProvider
    {
        ...
        private bool isSimulatingGaze => !isSimulatingLeft && !isSimulatingRight && !IsAlwaysVisibleLeft && !IsAlwaysVisibleRight && !XRSubsystemHelpers.IsDisplaySubsystemRunning();
        /// <summary>
